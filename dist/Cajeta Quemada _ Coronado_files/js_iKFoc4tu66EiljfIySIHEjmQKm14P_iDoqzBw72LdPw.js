...
/***/ "./src/js/theme_coronado.script.js":
/*!*****************************************!*\
  !*** ./src/js/theme_coronado.script.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(function ($, Drupal) {
  ...
  $(document).ready(function () {
    // OPACITY MAIN OUT
    $('main').removeClass('fadeOut'); // TEXT CHANGE BANNERS

    $('.banner-top h1').text('¿Ya sabes qué preparar hoy o necesitas inspiración?'); // NAV BRAND ID's

    $('#branding-menu a').attr('id', 'brand-nav-a');
    $('#branding-menu img').attr('id', 'brand-nav-img'); // ADD ID TROUGH NAV ITEMS
    ...
    $('#secondary-menu span').attr('id', 'search-nav');
    ...
    $("#sociallinks ul li a").each(function () {
      $(this).attr('id', function (index) {
        return "nav-item-" + cnt;
      });
      cnt++;
    ...
    $(".block--theme-coronado-footer ul li a").each(function () {
      $(this).attr('id', function (index) {
        return "nav-item-" + cnt;
      });
      cnt++;
    ...
    $('#descubreBtn .terciary').attr('id', 'quiz-nav');
    // ID video-btn

    $('.video-btn').attr('id', 'video-nav'); // FULLPAGE CAROUSEL

    function initFullpage() {
      //INIT FULLPAGE CAROUSEL
      ...
      $('#fullpage').fullpage({
        ...
        onLeave: function onLeave(origin, destination, direction) {
          ...
          if (origin == 1 && direction == 'down') {
            ...
            $(".header--navegacion").addClass("headerOn");
          } else if (origin == 2 && direction == 'up') {
            // alert("Going to section 1!");
            $('header').removeClass('activo');
            $(".header--navegacion").removeClass("headerOn");
          }
        }
      });
    } // SECTIONS
    ...
    if ($('.path-frontpage').length) {
      ...
      var $videoSrc; // Gets the video src from the data-src on each button

      $(document).on('click', '.video-btn', function () {
        $('#splashVideo').modal('show');
      ...
      $('#splashVideo').on('shown.bs.modal', function (e) {
        // set the video src to autoplay and not to show related video. Youtube related video is like a box of chocolates... you never know what you're gonna get
        $("#video").attr('src', $videoSrc + "?autoplay=1&amp;modestbranding=1&amp;showinfo=0");
      }); // stop playing the youtube video when I close the modal

      $('#splashVideo').on('hide.bs.modal', function (e) {
      ...
      $('#modal').on('shown.bs.modal', function (e) {
        var swiperQuiz = new Swiper('#slider-receta', {
          slidesPerView: 1,
          autoHeight: true,
          mousewheel: false,
          autoplay: false,
          ...
          // direction: 'vertical',
          navigation: {
            nextEl: '#next-button' // prevEl: '.swiper-button-prev',

          }
        }); // LISTA QUIZ PRODUCTOS

        $('#producto1').appendTo('#recipe-product');
        $('#producto4').appendTo('#recipe-product');
        $('#producto6').appendTo('#recipe-product');
        $('#producto7').appendTo('#recipe-product');
        $('#producto8').appendTo('#recipe-product');
        $('#producto9').appendTo('#recipe-product');
        $('#producto10').appendTo('#recipe-product');
      });
    }

    ; // QUIENES SOMOS

    if ($('.quienes-somos').length) {
      //INIT FULLPAGE
      initFullpage();
    } // PRODUCTOS
    ...
    if ($('.productos').length) {
      $(".hero a").each(function () {
        var hrefPath = $(this).attr('href'); // var recipename = hrefPath.lastIndexOf('/');

        var split = hrefPath.split("/");
        split.splice(1, 1);
        hrefPath = split.join('-');
        console.log('URL lastname ' + hrefPath);
        $(this).attr('id', function (index) {
          return 'productos' + hrefPath;
        }); // cnt++;
      }); //INIT FULLPAGE
    ...
    if ($('.productos-detail').length) {
      ...
      $(".hero .underline").each(function () {
        ...
        console.log('URL lastname ' + hrefPath);
        $(this).attr('id', function (index) {
          return 'producto' + hrefPath;
        }); // cnt++;
      });
      var cnt = 1;
      $(".hero .buy-btn").each(function () {
        $(this).attr('id', function (index) {
          return 'link-producto-' + cnt++;
        });
        cnt++;
      }); //INIT FULLPAGE
    ...
    if ($('.recipe--related').length) {
      $(".grid--wrap__card a").each(function () {
        var hrefPath = $(this).attr('href'); // var recipename = hrefPath.lastIndexOf('/');
        ...
        hrefPath = split.join('-');
        console.log('URL lastname ' + hrefPath);
        $(this).find('img').attr('id', function (index) {
          return 'receta' + hrefPath;
        }); // cnt++;
      });
    } // RECETA - DETAIL
    ...
    if ($('.recetas').length) {
      ...
      $('body').addClass('fullHeight'); //INIT FULLPAGE
      // initFullpage();
      // LISTA QUIZ PRODUCTOS
    ...
    if ($('.recipe').length) {
      var cnt = 1; // RECIPE VIDEO

      $(".recipe--video .btn-recipe-s").each(function () {
        $(this).attr('id', function (index) {
          return 'receta-video-' + cnt++;
        });
        cnt++;
      }); // ADD SHARE BUTTONS
      // $('#receta-video-1').append('<div id="share-buttons" class="d-flex"> <div id="facebook" class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16"><path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/></svg></div> <div id="twitter" class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16"><path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/></svg></div> <div id="copiar" class="icon"><p>Copiar Link</p></div> </div>')
      //INIT FULLPAGE

      initFullpage(); // SECTION AUTO HEIGHT

      $('section').addClass('fp-auto-height');
      $('section.hero').removeClass('fp-auto-height'); // VIDEO SPLASH
      // SPLASH MODAL
    ...
    if ($('.trabajamos').length) {
      // MOBILE VERSION
      var windowWidthResize = function windowWidthResize() {
        if (widthW >= 480) {
          location.reload();
        } else {} //refresh on else
      ...
      var scrollMagic = function scrollMagic() {
        // console.log('ok scrollMagic');
        window.controller = new ScrollMagic.Controller({
          vertical: false
        });
        window.tween = new TimelineMax().add([TweenMax.to("#parallaxContainer .layer1", 1, {
        ...
        window.scene = new ScrollMagic.Scene({
          ...
          offset: 450
        }).setTween(tween).setClassToggle("#parallaxContainer", "active").setPin("#parallaxContainer") //.addIndicators({name: "parallaxContainer (duration: )" + widthW * 6}) // add indicators (requires plugin)
        .addTo(controller); // window.tween2 = TweenMax.to("#product-shoot", 0.5, { x: 600, ease: "slow"});

        window.scene = new ScrollMagic.Scene({
          duration: productDistance
        }) // .setTween(tween2)
        // .setPin("#product-shoot")
        .on("enter leave", updateIntro) // //.addIndicators({name: "1 (durations: )" + productDistance}) // add indicators (requires plugin)
        .addTo(controller);
        window.scene = new ScrollMagic.Scene({
          triggerElement: "#trigger1a",
          duration: productDistance
        }).setClassToggle("#headline-juntos", "fixed-pos") // //.addIndicators({name: "familia trigger2 (duration: )" + productDistance}) // add indicators (requires plugin)
        .addTo(controller); // BG1

        window.scene = new ScrollMagic.Scene({
          triggerElement: "#trigger1",
          duration: widthW
        }) // .setPin("#product-shoot")
        .setClassToggle(".trabajamos--familia", "op-one") // .setClassToggle("#bg1", "home-bg-trabajamos")
        .on("enter leave", updateBg) // .setClassToggle("#headline-juntos", "fixed-pos")
        //.addIndicators({name: "bg family (duration: )" + widthW}) // add indicators (requires plugin)
        .addTo(controller); // HEADLINE

        window.scene = new ScrollMagic.Scene({
          triggerElement: "#trigger2",
          duration: 0
        }).setClassToggle("#headline-juntos", "second") // //.addIndicators({name: "1 Headline (duration: 0)"}) // add indicators (requires plugin)
        .addTo(controller); // BG2

        window.scene = new ScrollMagic.Scene({
          triggerElement: "#trigger2",
          duration: widthW
        }).setClassToggle(".trabajamos--cabritas", "op-one").on("enter leave", updateBg2).addTo(controller); //
        // BG3

        window.scene8 = new ScrollMagic.Scene({
          triggerElement: "#trigger3",
          duration: widthW
        }).on("enter leave", updateBg3).setClassToggle(".trabajamos--orgullosos", "op-one").addTo(controller); // PRODUCT SHOOT

        /*window.scene9 = new ScrollMagic.Scene({triggerElement: "#trigger3", duration: productDistance + 220})
                // .setPin("#product-shoot")
                .on("enter leave", moveProduct)
                //.addIndicators({name: "orgullosos (duration: )" + productDistance + 220}) // add indicators (requires plugin)
                .addTo(controller);*/
        // BG4
        ...
        window.scene = new ScrollMagic.Scene({
          ...
          duration: widthW
        }).on("enter leave", updateBg4).setClassToggle(".trabajamos--compartimos", "op-one").addTo(controller); // POSTRE TWEEN

        window.tween2 = TweenMax.to(".postre", 1, {
          right: '0%',
          ease: Linear.easeNone
        }); // POSTRE
        ...
        window.tween3 = TweenMax.to(".box2", 1, {
          width: '80%',
          ease: "slow"
        }); // POSTRE
        ...
        window.scene = new ScrollMagic.Scene({
          ...
          duration: productDistance
        }).setTween(tween3) // .setClassToggle("#disfruta-juntos", "op-one")
        .on("enter leave", updateDisfruta).addTo(controller);
      }; // moveProduct
      // function moveProduct (e){
      //   if (e.type == 'enter') {
      //       $("#product-shoot").removeClass('moveRight');
      //   }else {
      //       $("#product-shoot").addClass('moveRight');
      //   }
      // }
      // HIDE INTRO


      var updateIntro = function updateIntro(e) {
        if (e.type == "enter") {
          // $("#pin p").text("Pinned.");
          $("#headline-descubre").removeClass('fadeOut');
          $("#product-shoot").removeClass('moveRight');
        } else {
          // $("#pin p").text("Unpinned.");
          $("#headline-descubre").addClass('fadeOut');
        }
      }; // SHOW DISFRUTA CIERRE


      var updateDisfruta = function updateDisfruta(e) {
        if (e.type == "enter") {
          $("#disfruta-juntos").removeClass('op-one');
        } else {
          $("#disfruta-juntos").addClass('op-one');
        }
      }; // CHANGE BACKGROUNDS


      var updateBg = function updateBg(e) {
        if (e.type == "enter") {
          // $("#pin p").text("Pinned.");
          $("#bg1").addClass('home-bg-trabajamos');
          $("#product-shoot").removeClass('moveRight');
          window.number = 0; // familia
          // $(".trabajamos--familia").removeClass('fadeOut');
        } else {
          // $("#pin p").text("Unpinned.");
          $("#bg1").removeClass('home-bg-trabajamos'); // $(".trabajamos--familia").addClass('fadeOut');
        }
      };

      var updateBg2 = function updateBg2(e) {
        if (e.type == "enter") {
          // $("#pin p").text("Pinned.");
          $("#bg1").addClass('home-bg-cabritas');
          $("#product-shoot").removeClass('moveRight');
          window.number = 0;
        } else {
          // $("#pin p").text("Unpinned.");
          $("#bg1").removeClass('home-bg-cabritas');
        }
      };

      var updateBg3 = function updateBg3(e) {
        if (e.type == "enter") {
          // $("#pin p").text("Pinned.");
          $("#bg1").addClass('home-bg-orgullosos');
          $("#product-shoot").addClass('moveRight');
          window.number = 0; // console.log('ProductDistance es ... ' + productDistance );
        } else {
          // $("#pin p").text("Unpinned.");
          $("#bg1").removeClass('home-bg-orgullosos');
        }
      };

      var updateBg4 = function updateBg4(e) {
        if (e.type == "enter") {
          // $("#pin p").text("Pinned.");
          $("#bg1").addClass('home-bg-compartimos');
        } else {
          // $("#pin p").text("Unpinned.");
          $("#bg1").removeClass('home-bg-compartimos');
        }
      };
      ...
      $('body').addClass('overflow-y-hidden'); // prepend fullage
      // $('#fullpage').prependTo('body');

      $('.trabajamos--familia').addClass('fadeOut');
      $('.trabajamos--cabritas').addClass('fadeOut');
      $('.trabajamos--orgullosos').addClass('fadeOut');
      $('.trabajamos--compartimos').addClass('fadeOut'); // NAVBAR FIXED

      $('.navbar').addClass('fixed-nav'); //INIT FULLPAGE
      // initFullpage();
      ...
      $('#fullpage').fullpage({
        ...
        loopHorizontal: false // dragAndMove: true,
        // interlockedSlides: true,
        // resetSliders: true,

      }); // GET WINDOW WIDTH / RESIZE
      ...
      $(window).on('resize', function () {
        widthW = $(window).width(); // console.log("Ancho de ventana es ... " + widthW);

        windowWidth();
        $(window).scrollLeft(0); // function reload controller

        windowWidthResize();
        productDistance = widthW / 4; // console.log("Recorrido de producto es ... " + productDistance);

        scrollMagic();
      }); // ON READY

      window.productDistance = widthW / 4; // windowWidthResize()
      // console.log('porcentaje 50% ' + widthW / 4);
    ...
    $(document).on('click', 'span:contains("Search")', function () {
      $('#search').modal('show');
    }); // BTN QUIZ MODALS

    $(document).on('click', '.terciary', function () {
      $('#modal').modal('show');
    });
    $(document).on('click', '#btn-ocasion', function () {
      $('#modal-ocasion').modal('show');
    });
    $(document).on('click', '#btn-producto', function () {
      $('#modal-producto').modal('show');
    });
    $(document).on('click', '#btn-tiempo', function () {
      $('#modal-tiempo').modal('show');
    });
    $(document).on('click', '#btn-nivel', function () {
    ...
    $('.close').on('click', function () {
      ...
      $('#search').modal('hide');
      $('.modal').modal('hide');
    }); // BUY BUTTON id="li-cart" href="https://coronado-sitio.2b.uy/?c=evgIodIFYfdfR4cH" target="_blank"

    $('#secondary-menu').find('a').attr('href', 'https://coronado-sitio.2b.uy/?c=evgIodIFYfdfR4cH');
    $('#secondary-menu').find('a').attr('data-tobuy-modal', 'open'); //  data-tobuy-modal="open" data-tobuy-hash="evgIodIFYfdfR4cH"

    $('#secondary-menu').find('a').attr('data-tobuy-hash', 'evgIodIFYfdfR4cH'); // SOCIAL NAV

    $('#sociallinks').find('a').attr('target', '_blank'); // RADIO ACTIVE DIV

    $('#nivel-de-cocina .icon').click(function () {
      $('.icon').removeClass('active');
      $(this).addClass('active');
    });
    $('#time-machine .input-btn').click(function () {
      $('.input-btn').removeClass('active');
      $(this).addClass('active');
    });
    var quiz = 0;
    $('#next-button').click(function () {
      ...
      if (quiz == 4) {
        ...
        $('#last-button').removeClass('d-none');
      } // console.log(quiz)
    ...
    $('#modal').on('hide.bs.modal', function (e) {
      ...
      $('#last-button').addClass('d-none');
    }); // RESULTS

    jQuery("#last-button").click(function () {
      var ocasion = jQuery("#recipe-ocasion option:selected").val();
      var producto = jQuery("#recipe-product option:selected").val();
      var tiempo = jQuery('div.input-btn.active > p').text();
      var nivel = jQuery("div.icon.active > p").text();
      jQuery('<form>', {
        "html": '<input type="text" name="product" value="' + producto + '" /><input type="text" name="time" value="' + tiempo + '" /><input type="text" name="temporality" value="' + ocasion + '" /><input type="text" name="level" value="' + nivel + '" />',
        "method": 'POST',
        "action": '/perfilador'
      }).appendTo(document.body).submit();
      window.dataLayer = window.dataLayer || []; // window.dataLayer.push({'event': 'quizcoronado'});
    ...
    }); // MODAL RECIPES RESULTS

    jQuery("#last-button-ocasion").click(function () {
      var ocasion = jQuery("#recipe-ocasion option:selected").val();
      window.location.href = "/recetas-coronado/ocasion/" + ocasion;
    });
    jQuery("#last-button-producto").click(function () {
      var producto = jQuery("#recipe-product option:selected").val();
      window.location.href = "/recetas-coronado/producto/" + producto;
    });
    jQuery("#last-button-tiempo").click(function () {
      var tiempo = jQuery("div.input-btn.active > p").text();
      var tiempov;

      if (tiempo === "10 a 30 minutos") {
        tiempov = "10-30min";
      } else if (tiempo === "30 min a 60 minutos") {
        tiempov = "30-60min";
      } else if (tiempo === "90 a 180 minutos") {
        tiempov = "90-180min";
      }

      window.location.href = "/recetas-coronado/tiempo/" + tiempov;
    });
    jQuery("#last-button-nivel").click(function () {
      var nivel = jQuery("div.icon.active > p").text();
      window.location.href = "/recetas-coronado/habilidad/" + nivel;
    });
  });
})(jQuery, Drupal);
...
/***/ "./src/scss/theme_coronado.style.scss":
/*!********************************************!*\
  !*** ./src/scss/theme_coronado.style.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"/js/theme_coronado.script": 0,
/******/ 			"css/theme_coronado.style": 0
/******/ 		};
/******/
...
/******/ 	__webpack_require__.O(undefined, ["css/theme_coronado.style"], () => (__webpack_require__("./src/js/theme_coronado.script.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/theme_coronado.style"], () => (__webpack_require__("./src/scss/theme_coronado.style.scss")))
